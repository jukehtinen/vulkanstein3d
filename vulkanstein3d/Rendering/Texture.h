...
class Texture
{
  public:
    ...
    static std::shared_ptr<Texture> CreateTexture(std::shared_ptr<Device> device, std::shared_ptr<Buffer> stagingBuffer, uint32_t width, uint32_t height, uint32_t layers = 1);
