...
struct Color
{
    Color(uint8_t r, uint8_t g, uint8_t b, uint8_t a = 255)
        : r(r * 255u / 63), g(g * 255u / 63), b(b * 255u / 63), a(a)
    {
    }
